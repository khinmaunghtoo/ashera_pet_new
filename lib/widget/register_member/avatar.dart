...
class RegisterMemberAvatar extends StatefulWidget {
  const RegisterMemberAvatar({super.key});

  @override
  State<StatefulWidget> createState() => _RegisterMemberAvatarState();
}

class _RegisterMemberAvatarState extends State<RegisterMemberAvatar> {
      ...
      children: [
        ...
        Expanded(
          ...
          children: [
            ...
            //addButton
            Positioned(
                right: 8, bottom: 8, child: blueAddButton(23, () => _onTap())),
          ],
        )),
        const SizedBox(
          height: 10,
  ...
  Widget _avatar() {
    if (newPhoto != null) {
      return _fileAvatar();
    } else if (Member.memberModel.mugshot.isNotEmpty) {
      return _catchAvatar();
    } else {
      return _noAvatar();
    }
  ...
  Widget _catchAvatar() {
    return Container(
        ...
        child: CachedNetworkImage(
          imageUrl: Utils.getFilePath(Member.memberModel.mugshot),
  ...
  void _onTap() async {
    ...
    if (files.isNotEmpty) {
      ...
      if (croppedFile != null) {
        ...
        Member.memberModel =
            Member.memberModel.copyWith(mugshot: croppedFile.path);
        setState(() {});
      }
    }
  ...
  //     Member.memberModel = Member.memberModel.copyWith(mugshot: media.path!);
  //     setState(() {});
  //   }
  // }
  ...
  //     Member.memberModel =
  //         Member.memberModel.copyWith(mugshot: media.first.path!);
  //     setState(() {});
  //   }
  // }
}
