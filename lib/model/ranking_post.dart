...
class RankingPostModel{
  ...
  factory RankingPostModel.fromMap(Map<String, dynamic> map){
    return RankingPostModel(
        id: map['id'] as int? ?? 0,
  ...
  factory RankingPostModel.fromJson(String source) => RankingPostModel.fromMap(json.decode(source) as Map<String, dynamic>);

  RankingPostModel copyWith({
    int? id,
    int? memberId,
    int? memberPetId,
    int? postId,
  ...
  bool operator ==(Object other) {
    ...
    return other is RankingPostModel &&
        other.id == id &&
